...
import "./App.css";
import { AuthType, HostEvent, init } from "@thoughtspot/visual-embed-sdk";
import {
  LiveboardEmbed,
  SearchEmbed,
  useEmbedRef,
...
function App() {
  ...
  const handlePinForPinboard = async () => {
    const res = await liveboardRef.current.trigger(HostEvent.Pin, {
      ...
      liveboardId: "6dabda7b-5392-4d47-ba26-17e8244cbcaf",
    });
    console.log("Pin result (liveboard)" ,res);
  };
    ...
    <>
      ...
      <div className="container">
        <div className="card">
          ...
          <LiveboardEmbed liveboardId="e40c0727-01e6-49db-bb2f-5aa19661477b" ref={liveboardRef} />
        </div>
        <div className="card">
          <h2>Search Embed</h2>
          <div>
