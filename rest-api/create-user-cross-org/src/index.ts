...
app.post("/create-user", async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        const requestBody: RequestBody = {
          users: [
            {
              user_identifier: USER_IDENTIFIER, // Make sure that user with this username does not exist
              ...
              email: USER_EMAIL,
              org_identifiers: [
                ORG_IDENTIFIER1,   // Make sure that org o1 exist in the system
                ORG_IDENTIFIER2    // Make sure that org o2 exist in the system
              ],
            },
          ],
          dry_run: false,
